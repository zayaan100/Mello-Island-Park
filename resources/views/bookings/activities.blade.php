...
@section('title', 'Book '.$activityName)
...
<div class="container py-5">
    <div class="booking-card">
        <h2 class="mb-3" style="font-size:32px;font-weight:600;">Book {{ $activityName }}</h2>
        <p class="mb-4">
            <strong>${{ $price }} / person ·</strong>
            <span class="text-success">Spots available</span>
        </p>

        <form method="POST" action="{{ route('activity.book.confirm', ['activityName' => $activityName]) }}">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="number" name="people" class="form-control" min="1" max="6"
                       value="{{ old('people', 1) }}">
